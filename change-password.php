...
if (isset($_POST['submit'])) {
    ...
    $change_pass = mysqli_query($conn,"UPDATE users SET password='$newpassword' WHERE sno='$user_id'");
    if ($change_pass > 0) {
        $msg = "Password Changed Successfull";
    }else{
        $error = "Password Changing Failed Please try again";
    }
}
?>
<!DOCTYPE html>
...
<head>
    ...
    <title>JEPRS | change password</title>
                                ...
                                <div class="col-md-8 col-md-offset-2">
                                    <div class="panel">
                                        ...
                                        <div class="alert alert-danger left-icon-alert" role="alert">
                                            <strong>Fail!</strong> <?php echo htmlentities($error); ?>
                                        </div>
                                        <?php } ?>
