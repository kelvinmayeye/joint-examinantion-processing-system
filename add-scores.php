                            ...
                            <div class="row breadcrumb-div">
                                <div class="col-md-6">
                                    <ul class="breadcrumb">
                                        ...
                                        <li class="active">Add Student Score</li>
                                    </ul>
                                </div>
...
<label for="default" class="col-sm-2 control-label">Studentid</label>
<div class="col-sm-10">
<input type="number" name="sid" class="form-control" id="fullanme" required="required" autocomplete="off">
</div>
</div>
...
<div class="col-sm-10">
<input type="number" name="scores" class="form-control" id="fullanme" required="required" autocomplete="off" max="100" min="0">
</div>
</div>
