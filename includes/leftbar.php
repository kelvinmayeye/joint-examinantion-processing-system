<div class="left-sidebar bg-black-300 box-shadow ">
                                ...
                                <ul class="side-nav color-gray">
                                   ...
                                   <!--  <li class="nav-header">
                                    ...
                                    <li class="has-children">
                                        ...
                                        <ul class="child-nav">
                                            <li><a href="create-class.php"><i class="fa fa-bars"></i> <span>Add School</span></a></li>
                                            <li><a href="manage-classes.php"><i class="fa fa fa-server"></i> <span>view school</span></a></li>
  ...
  <li class="has-children">
                                        ...
                                        <ul class="child-nav">
                                            <li><a href="create-subject.php"><i class="fa fa-bars"></i> <span>Add User</span></a></li>
   ...
   <li class="has-children">
                                      ...
                                      <li class="has-children">
                                        ...
                                        <ul class="child-nav">
                                            <li><a href="add-students.php"><i class="fa fa-bars"></i> <span>Add Score</span></a></li>
                                            <li><a href="manage-students.php"><i class="fa fa fa-server"></i> <span>View Score</span></a></li>
