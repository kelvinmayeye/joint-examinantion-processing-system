...
$query->bindParam(':regno',$registration,PDO::PARAM_STR);
$query->bindParam(':schoolname',$name_school,PDO::PARAM_STR);
$query->bindParam(':schooltype',$natureofschool,PDO::PARAM_STR);
$query->execute();
                            ...
                            <div class="row breadcrumb-div">
                                <div class="col-md-6">
                                    <ul class="breadcrumb">
                                        ...
                                        <li class="active">School Admission</li>
                                    </ul>
                                </div>
...
<div class="col-sm-10">
<input type="text" name="regno" class="form-control" id="fullanme" required="required" autocomplete="off">
</div>
</div>
...
<div class="col-sm-10">
<input type="text" name="schoolname" class="form-control" id="rollid" required="required" autocomplete="off">
</div>
</div>

<div class="form-group">
<label for="schooltype" class="col-sm-2 control-label">School Type</label>
<div class="col-sm-10">
